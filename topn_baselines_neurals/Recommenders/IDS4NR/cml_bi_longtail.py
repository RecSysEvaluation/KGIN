...
class CML_Bi_Disen8(torch.nn.Module):
    def __init__(self, user_num, item_num, user_feat_num, item_feat_num, item_feat_len, dim_num, margin = 0) -> object:
    ...
    def forward(self, user_indices, user_feat, pos_item_indices, pos_item_feat, neg_item_indices, neg_item_feat, comp_neg_indices):
        # user_indices, item_indices, user_feat, item_feat, comp_neg_indices
